...
|---|--:|--:|--:|--:|--:|--:|
| GP2X | 673 | 424 | 16 | 86 | 147 | 0 |
| Wiz | 153 | 57 | 1 | 39 | 56 | 0 |
| Caanoo | 205 | 76 | 21 | 22 | 86 | 0 |
| **All** | **1031** | **557** | **38** | **147** | **289** | **0** |
...
| **Renders at speed but no audio** (`no-audio`) | 97 | Caanoo, GP2X, Wiz | n/a |
| **No .gpe in the dump** (`no-executable`) | 59 | Caanoo, GP2X, Wiz | n/a |
| **Draws only a flat colour** (`flat-fill`) | 15 | Caanoo, GP2X | n/a |
| **Renders but below 20 fps** (`low-fps`) | 14 | Caanoo, GP2X | n/a |
...
| a_sn-pong | `playable` | 42.0 | 1554 | – | no-audio |  |
...
| AMazing-3D | `playable` | 65.0 | 1638 | – | no-audio |  |
...
| Birdshoot | `playable` | 62.0 | 1554 | – | no-audio |  |
...
| Chopper | `playable` | 61.1 | 1554 | – | no-audio |  |
...
| cosmo2x_01 | `playable` | 61.7 | 1560 | – | no-audio |  |
...
| dopewars2x | `playable` | 61.4 | 1542 | – | no-audio |  |
| dosmugen | `playable` | 59.6 | 1557 | ✓ |  |  |
| Drill2x_final | `playable` | 60.1 | 1537 | ✓ |  |  |
| drill2x_xtreme_v1.0.3 | `playable` | 60.6 | 1551 | ✓ |  |  |
| drod-gp2x-1_0 | `playable` | 52.1 | 1350 | – | no-audio |  |
| dstroyGP2X1402 | `playable` | 60.5 | 1552 | – | no-audio |  |
...
| escoba_exp-20101016.gp2x | `playable` | 61.3 | 1556 | – | no-audio |  |
| exi_shoot_gp2x | `playable` | 61.3 | 1542 | ✓ |  |  |
| extraterrestres | `playable` | 98.2 | 2644 | ✓ |  |  |
| extraterrestres-0 | `playable` | 58.8 | 1561 | – | no-audio |  |
| exult_rc3 | `playable` | 41.6 | 1541 | ✓ |  |  |
| Factor-v1.0-final | `playable` | 61.0 | 1552 | ✓ |  |  |
| falldown_gp2x | `playable` | 93.0 | 2337 | ✓ |  |  |
| FCRLG | `playable` | 61.4 | 1543 | – | no-audio |  |
| fifteen_01 | `playable` | 59.8 | 564 | – | no-audio |  |
...
| flowflowmania-0_6-gp2x | `playable` | 45.0 | 441 | – | no-audio |  |
...
| freesci | `playable` | 57.8 | 260 | – | no-audio |  |
| friq-beta-07 | `playable` | 61.2 | 1555 | ✓ |  |  |
| frozen2x-0.1 | `playable` | 79.0 | 738 | ✓ |  |  |
| fruits2x | `playable` | 51.5 | 107 | – | no-audio |  |
...
| gchess-v1.0.1-bin | `playable` | 61.3 | 1557 | – | no-audio |  |
...
| gp2x-tong-v1 | `playable` | 116.3 | 2941 | – | no-audio |  |
...
| gp2xgo-v1.1.0-bin | `playable` | 61.4 | 1554 | – | no-audio |  |
| gp2xjunkie | `playable` | 58.7 | 1508 | ✓ |  |  |
| gp2xmancala-v1.1.1-bin | `playable` | 61.6 | 1555 | – | no-audio |  |
| GP2XOfLife | `playable` | 113.4 | 2863 | – | no-audio |  |
...
| kampfimall-gp2x | `playable` | 61.2 | 1543 | – | no-audio |  |
...
| LABYRINTH | `playable` | 61.8 | 1556 | – | no-audio |  |
...
| mancala-v1.0.1 | `playable` | 61.5 | 1560 | – | no-audio |  |
...
| masterpiece2x | `playable` | 61.8 | 1558 | – | no-audio |  |
...
| minigolf | `playable` | 61.2 | 1552 | – | no-audio |  |
...
| Nebulus_gp2x | `playable` | 61.9 | 1554 | – | no-audio |  |
| NecNec2x | `playable` | 61.7 | 1563 | ✓ |  |  |
| Net-Bubble-gp2x_1-21-06_bin | `playable` | 56.3 | 526 | – | no-audio |  |
...
| PerfectFit | `playable` | 61.8 | 1556 | – | no-audio |  |
...
| PocketSnes_SMRPG | `playable` | 118.6 | 2982 | – | no-audio |  |
| Poker2x | `playable` | 109.0 | 2776 | ✓ |  |  |
| Poker_Gp2Xv1.0 | `playable` | 116.4 | 2970 | ✓ |  |  |
| Pond2X | `playable` | 61.4 | 1542 | – | no-audio |  |
| Pong | `playable` | 61.6 | 1545 | – | no-audio |  |
| pong2player | `playable` | 58.0 | 118 | – | no-audio |  |
| pong2v060x | `playable` | 55.6 | 114 | – | no-audio |  |
| Pool Panic | `playable` | 61.0 | 1539 | ✓ |  |  |
| powder2x-112 | `playable` | 61.0 | 1557 | – | no-audio |  |
| powermanga-0.80 | `playable` | 56.2 | 1479 | ✓ |  |  |
| PowerSlide | `playable` | 60.9 | 1542 | ✓ |  |  |
| PPlane | `playable` | 60.3 | 1525 | ✓ |  |  |
| PPlane2.GP2X | `playable` | 59.3 | 1574 | ✓ |  |  |
| prboom-gp2x | `playable` | 61.0 | 1557 | – | no-audio |  |
...
| RevoltOfTheBinaryCouriers GP2X | `playable` | 61.1 | 1538 | – | no-audio |  |
...
| rubik | `playable` | 122.6 | 3104 | – | no-audio |  |
...
| scummvm-kor0.4.2cvs | `playable` | 60.5 | 1536 | – | no-audio |  |
| SdLame | `playable` | 61.3 | 1559 | ✓ |  |  |
| sdlmonkey_0.1 | `playable` | 61.5 | 1552 | – | no-audio |  |
...
| Simon2X | `playable` | 60.5 | 1536 | – | no-audio |  |
...
| snake2x-1.1 | `playable` | 60.7 | 1557 | – | no-audio |  |
| snowedin5_v1-00_gp2x | `playable` | 61.6 | 1552 | ✓ |  |  |
| SOD v1.1 | `playable` | 60.2 | 1553 | ✓ |  |  |
| sokobangp2x | `playable` | 54.6 | 1561 | ✓ |  |  |
| Solitaire2x-v1.4 | `playable` | 80.9 | 752 | – | no-audio |  |
| sources_MEMORY2X | `playable` | 60.8 | 1554 | – | no-audio |  |
| sources_Yahtzee | `playable` | 52.2 | 226 | ✓ |  |  |
| space squares | `playable` | 60.9 | 1549 | – | no-audio |  |
| space_varments_v1.0 | `playable` | 56.7 | 565 | ✓ |  |  |
| SpaceRocks2X | `playable` | 54.6 | 157 | – | no-audio |  |
| SpaceSnake | `playable` | 115.9 | 1996 | ✓ |  |  |
| spacestorm | `playable` | 56.0 | 1410 | ✓ |  |  |
| spartak-chess_0.0.4_gp2x | `playable` | 61.3 | 1553 | – | no-audio |  |
| Sponge Blob Tennis | `playable` | 42.0 | 1555 | – | no-audio |  |
| spout | `playable` | 61.6 | 1550 | – | no-audio |  |
| Sqcolony | `playable` | 63.7 | 1605 | – | no-audio |  |
...
| sudoku-v1.0 | `playable` | 61.6 | 1554 | – | no-audio |  |
| sudoku2x-0.5 | `playable` | 61.1 | 1539 | – | no-audio |  |
...
| Tangle | `playable` | 62.1 | 1558 | – | no-audio |  |
...
| TimeFrack2D for GP2X | `playable` | 48.8 | 100 | – | no-audio |  |
| TouchGames | `playable` | 117.3 | 2967 | ✓ |  |  |
| tower | `playable` | 109.5 | 2774 | – | no-audio |  |
| towertopplergp2x | `playable` | 59.5 | 1554 | ✓ |  |  |
| Trap75 | `playable` | 61.7 | 1552 | ✓ |  |  |
| treev060 | `playable` | 60.5 | 1556 | ✓ |  |  |
| ttxbeta170706b | `playable` | 57.9 | 1553 | – | no-audio |  |
...
| vexedb1 | `playable` | 61.7 | 1556 | – | no-audio |  |
| vorton-b4 | `playable` | 59.4 | 1554 | ✓ |  |  |
| waffle2x | `playable` | 42.9 | 91 | – | no-audio |  |
...
| wire3d | `playable` | 58.9 | 1530 | – | no-audio |  |
...
| gobble | `playable` | 45.5 | 141 | – | no-audio |  |
...
| Powder2X_wiz_114_v01 | `playable` | 58.7 | 1495 | – | no-audio |  |
...
| spout | `playable` | 61.1 | 1539 | – | no-audio |  |
| Sqdef_Wiz_14A | `playable` | 60.1 | 1539 | ✓ |  |  |
| Sudoku2X | `playable` | 60.8 | 1533 | – | no-audio |  |
| Tail Tale | `playable` | 61.0 | 1534 | ✓ |  |  |
| wizchess-v1.1.0-bin | `playable` | 60.7 | 1536 | – | no-audio |  |
| wizchess-v1.2.0-bin | `playable` | 60.9 | 1541 | – | no-audio |  |
| WizFrontier v0.1 | `playable` | 60.8 | 1606 | ✓ |  |  |
| wizgo-v1.1.0-bin | `playable` | 60.7 | 1541 | – | no-audio |  |
| WizGolf | `playable` | 60.9 | 1539 | – | no-audio |  |
| wizmancala-v1.1.2-bin | `playable` | 61.0 | 1542 | – | no-audio |  |
| wizpong | `playable` | 60.1 | 1526 | – | no-audio |  |
...
| balls12_caanoo_bin | `playable` | 37.1 | 76 | – | no-audio |  |
| battlejewels-105-caanoo-beta | `playable` | 53.4 | 1350 | ✓ |  |  |
| Blackjack21v1.1 | `playable` | 59.8 | 1509 | – | no-audio |  |
| caanoo-12swap-v1.0-bin | `playable` | 39.5 | 999 | ✓ |  |  |
| caanoo-chess-v1.1.0-bin | `playable` | 44.7 | 1130 | – | no-audio |  |
| caanoo-gnurobbo-0.68 | `playable` | 32.2 | 432 | ✓ |  |  |
| caanoo-go-v1.1.0-bin | `playable` | 45.3 | 1144 | – | no-audio |  |
| caanoo-mancala-v1.1.0-bin | `playable` | 43.7 | 1103 | – | no-audio |  |
...
| tlosaf_v12-caanoo | `playable` | 61.4 | 1547 | – | no-audio |  |
...
| Vigo | `playable` | 53.0 | 909 | – | no-audio |  |
...
| wolf4sdl-caanoo | `playable` | 60.3 | 1537 | – | no-audio |  |
| wvector | `playable` | 44.0 | 1105 | ✓ |  |  |
| zelda-roth-olb-3t_caanoo | `playable` | 20.5 | 551 | ✓ |  |  |
